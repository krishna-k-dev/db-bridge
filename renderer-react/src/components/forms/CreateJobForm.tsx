                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select value={selectedScheduleType} onValueChange={(value) => {
                      ...
                      <Input id="schedule" name="schedule" placeholder="*/2 * * * *" value={schedule} onChange={(e) => setSchedule(e.target.value)} required className="mt-2" />
                      <p className="text-sm text-gray-500">Cron expression or use preset above</p>
                    </div>
